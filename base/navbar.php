        ...
        <div class="col">
          <p class="social mb-0">
            ...
            <a href="#"
              ...
              ><span class="sr-only">Googleplus</span></a
            >
          </p>
        </div>
...
>
  <div class="container d-flex align-items-center">
    ...
    <div class="collapse navbar-collapse" id="ftco-nav">
      ...
      <?php if ($page == 'index.php') { ?><li class="nav-item"><a href="index.php" class="nav-active nav-link"> HOME </a></li>
      <?php } else { ?><li class="nav-item"><a class="nav-link" href="index.php"> HOME </a><?php } ?> 

      <?php if ($page == 'about.php') { ?><li class="nav-item"><a href="about.php" class="nav-active nav-link"> ABOUT </a></li>
      <?php } else { ?><li class="nav-item"><a class="nav-link" href="about.php"> ABOUT </a><?php } ?> 
      
      <?php if ($page == 'services.php') { ?><li class="nav-item"><a href="services.php" class="nav-active nav-link"> SERVICES </a></li>
      <?php } else { ?><li class="nav-item"><a class="nav-link" href="services.php"> SERVICES </a><?php } ?> 

      <?php if ($page == 'contact.php') { ?><li class="nav-item"><a href="contact.php" class="nav-active nav-link"> CONTACT </a></li>
