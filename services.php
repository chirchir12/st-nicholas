...
<body>
    ...
    <section class="service-container mt-3">
        <div class="container">
            ...
            <div class="rehabilitation-container">
                ...
                <div class="row">
                    <div class="col-12 col-md-7">
                        ...
                        <p>We specialize in drug rehabilitation which is the process of medical or psychotherapeutic
                            treatment for dependence on psychoactive substances and street drug</p>
                    ...
                    <div class="col-12 col-md-5">
                        <img src="images/drug-about.jpg" class="img-fluid" alt="drugs">
                        <img src="images/child-drug-abuse.png" class="img-fluid" alt="drug">
                    </div>
                </div>
                <div class="stages-rehabilitation mt-3">
                    ...
                    <ul>
                        ...
                        <li><span class="sub-stage">Individual treatment plan-</span>This is where the course of
                            ...
                            defined. It delineates the goals, objectives and resources of an individual</li>
                        <li><span class="sub-stage">Detoxification- </span>this is the process of removing addictive
                            substances from the
                        ...
                        <li><span class="sub-stage">Employment services-</span>St Nicholas Rehabilitation Center aims at
                            avoiding relapse at all cost hence we find out what the clients are skilled in after
                            completing the rehabilitation process. We offer them direct or indirect employment, as well
                            financing their talents and business enterprises. At this stage, we partner with RITI
                            Association’ a project of St Nicholas rehabilitation and Nursing Home to achieve the best
                            results.</li>
                        <li><span class="sub-stage">Aftercare services-</span>This is a follow up treatment stage to
                            ensure
            ...
            <div class="nursing-services mt-4">
                <h5 class="nursing-title treatmentstyles">NURSING SERVICES</h5>
                <p>We have a skilled and knowledgeable personnel consisting of nursing aides that provide the
                    best
                    medical care. Our nursing home operates daily on a 24 hour system. The facility also offers
                    hospice
                        ...
                        <div class="other-services">
                            ...
                            <ul>
                                ...
                                <li>Social and recreational activities such as games which include, football, chess,
                                    ...
                                    educational
                                    movies, music that create positive impact to a client. We also encourage patients to
            ...
            <div class="dropdown-divider"></div>
            <div class="counselling-services mt-4">
                <h5 class="treatmentstyles counsellint-title">COUNSELING SERVICES</h5>
                <p>This service involves counseling on the 12 steps to recovery. There are various types of counseling
                    offered which includes; addiction counseling ,child counseling, family counseling and psychological
                    counseling, mental health counseling , substance abuse counseling education counseling and marriage
                    counseling.</p>
                <div class="stages-in-counselling">
                    <div class="row">
                        <div class="col-12 col-md-6"><span>The experts on counseling are keen in following the stages of
                            ...
                            <ul>
                                <li><span class="sub-stage">Pre-contemplation - </span>This is whereby the patient has
                                    ...
                                    encourages the re-evaluation of the current behavior and self –exploration so that
                                    the patient is given a clear picture of how their behavior is harmful.</li>
                                <li><span class="sub-stage">Contemplation - </span>This is where the pros of behavioral
                                    change become
                                    known to the patient and he or she focuses on it. Then the counselor encourages and
                                    promote positive outcome as required.</li>
                                <li><span class="sub-stage">Action -</span>This is where the patient practice the
                                    acquired positive
                                    behavior usually between 3 to 6 months depending on their improvements. The
                                    counselor encourages social support, bolsters self-efficiency for dealing with
                                    obstacles and helps the client to combat their feelings of loss to reinstate long
                                    term benefits.</li>
                        ...
                        <div class="col-12 col-md-6 d-flex align-items-center">
                            <img src="images/counselling-services.jpg" alt="counselling"
            ...
            <div class="dropdown-divider"></div>
            <div class="education">
                <h5 class="secondary-education treatmentstyles">SECONDARY EDUCATION AND INDUSTRIAL TRAINING INSTITUTE
                </h5>
